import sys
from prompts.examples import icl_examples
from prompts.instructions import task_instructions
from prompts.templates import prompt_templates

def create_prompt(strategy: str, task_type: str, examples_origin: str,
                   question_or_context: str, answer_or_step: str = None) -> str:
    """Creates a prompt for a current question/context and (optionally) answer
    ...
    Args:
        ...
        examples_origin: Dataset of origin of the in-context examples. Options
            are 'gsm8k', 'asdiv', 'aqua', 'prm800k'.
...
if __name__ == "__main__":
    print(create_prompt(*sys.argv[1:]))
